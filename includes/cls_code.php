...
class BarCode128 {
    ...
    const STARTC = 105;
    const STOP = 106;
    public $unit_width = 1.5; //单位宽度 缺省1个象素
    public $is_set_height = false;
    public $width = -1;
    private $heith = 55;
    private $quiet_zone = 6;
    public $font_height = 15;
    private $font_type = 15;
    ...
    public function setUnitWidth($unit_width) 
    {
        ...
        $this->quiet_zone = $this->unit_width*60;
        $this->font_height = $this->unit_width*150;
