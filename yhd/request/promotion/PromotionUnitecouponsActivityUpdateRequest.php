...
class PromotionUnitecouponsActivityUpdateRequest {
	...
	{
		return "yhd.promotion.unitecoupons.activity.update";
	}
	...
	/**活动关联的类目信息列表(当活动类型activityType的值为2时,为必须项)*/
	private  $categoryList; 
	/**活动关联的商品列表(当活动类型activityType的值为3时,为必须项)*/
	private  $productList; 
	/**持券商家id*/
	...
	public function setVerifyRemark($verifyRemark){
		...
		$this->apiParas["verifyRemark"] = $verifyRemark;
	}
